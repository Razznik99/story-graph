        ...
        <div className="flex h-full w-full overflow-hidden bg-background">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                        {isTimelineNote ? (
                            <div className="flex flex-col">
                                ...
                                <h1 className="text-xl font-bold text-foreground truncate" title={title}>{title}</h1>
                            </div>
                        ) : (
                            <Input
                                value={title}
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-8 max-w-5xl mx-auto w-full space-y-6">
                    ...
                    <div className="bg-surface rounded-xl border border-border/50 shadow-sm min-h-[400px]">
                        <SimpleEditor
                            key={note?.id || 'new'}
                            content={content}
                            onChange={setContent}
                    ...
                    {/* Metadata / Tags */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-surface p-4 rounded-xl border border-border/50">
                        {note?.updatedAt && (
